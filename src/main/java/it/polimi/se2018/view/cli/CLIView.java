...
public class CLIView extends View implements Runnable {
    ...
    private void manageCommand(INPUT_STATE currentState, String input) {
        ...
        //MODIFICA:
        //@DAN OSSERVAZIONE: questo assegnamento va bene tranne se sto inviando un notify all'utente.
        // Potrebbe infatti fare interferenza con lo stato che il server mi assegna da remoto.
        // Se per caso il server è più veloce di questo assegnamento, e ti invia un timeout, tu in realtà
        // lo stai sovrascrivendo con lo stato che gli vuoi imporre da locale con questo assegnamento.
        // Per risolvere, bisognerebbe fare il calcolo della funzione dentro ogni case necessario e basta.
        // Quindi TOGLIERLO dai reply e da ogni volta che si fa notify()
